# mlamehticket — Backup, Restore & Database Management Guide
...
mlamehticket app provides two types of backups:
...
mysql -u root -p -e "CREATE DATABASE mlamehticket CHARACTER SET utf8mb4;"
...
```bash
crontab -e
# Add: 0 2 * * * cd /path/to/mlamehticket-app && .venv/bin/python manage.py backup_db
```
