...
Use **Details** to open the details drawer. It shows ticket metadata and related information (for example related Knowledge Base articles when present). Close the drawer when you are done.
