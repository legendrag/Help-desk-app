...
class EmailAppearance(TimeStampedModel):
    """Singleton branding settings for notification emails."""
    ...
    def __str__(self) -> str:
        return f"Email appearance ({self.brand_name})"
...
class EmailTemplate(TimeStampedModel):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="When off, built-in default copy is used instead.",
    )
